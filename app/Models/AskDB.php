...
class AskDB extends Model
{
    ...
    public static function ask($question): string
    {
        ...
        if($query === '[]') {
            return "It's possible that your question contains something not related to projects, phases or tasks. Please reformulate your question.";
        }
        ...
        try {
            ...
            return 'There was an unexpected error. Please try again in a moment or try to reformulate your question.';
        }
