    ...
    <body class="bg-gray-100">
        <div class="flex items-center justify-center min-h-screen p-5 bg-blue-100 min-w-screen">
            <div class="mx-auto max-w-2xl p-6 bg-white shadow-md rounded-md">
                ...
                <p class="text-lg text-center leading-7">Hello {{ $task->leader->name }}. One of the tasks you've assigned has been finished. <br> {{ $task->title }} from {{ $task->project->title }}</p>
            </div>
        </div>
    </body>
</html>